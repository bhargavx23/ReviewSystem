    ...
    >
      {batches.map((batch, index) => {
        ...
        return (
          <motion.article
            ...
            className={cn(
              "bg-base-100 rounded-xl shadow-sm p-4 flex flex-col h-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary-300",
              statusProps.border,
            )}
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1">
                ...
                <p className="text-sm text-base-content line-clamp-2 mt-1">
                  {batch.projectTitle}
                </p>
              </div>
            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              <div>
                <div className="text-xs text-base-content">Team Leader</div>
                <div className="font-semibold text-sm">
                  {batch.teamLeaderName || "TBA"}
                </div>
              </div>
              <div className="ml-auto text-right">
                <div className="text-xs text-base-content">Students</div>
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 bg-primary-600 text-white rounded-md text-sm font-semibold hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-300 bg-primary-token"
      ...
      {batches.length === 0 && (
        ...
        >
          ...
          <p className="text-base text-base-content max-w-md mx-auto">
